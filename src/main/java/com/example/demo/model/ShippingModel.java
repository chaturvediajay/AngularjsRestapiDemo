...
public class ShippingModel {
	...
	public String toString() {
		...
		return "sName:-" + sName + " sAddress1:-" + sAddress1 + " sAddress2:-" + sAddress2 + " sModile:- " + sMobile
				+ " sState:-" + sSate + "  sCity:-" + sCity + " sPincode:-" + sPincode;
	}
	...
	public ShippingModel(HttpServletRequest request) {
		...
		this.sSate = request.getParameter("sState");
	...
	public String getsSate() {
		return sSate;
	}

	public void setsSate(String sSate) {
		this.sSate = sSate;
	}
