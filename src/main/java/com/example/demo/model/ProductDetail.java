...
@Entity
@Table(name = "product_detail",uniqueConstraints = @UniqueConstraint(columnNames = { "size", "color"}) )
public class ProductDetail {
	...
	public String toString() {
		...
		return "mrp:- "+mrp+" smrp:-"+smrp+" count:- "+count+" pkey:-"+pkey+" size:-"+size+"  color:-"+color+"  url:-"+url+" uid:-"+uid;
	}
